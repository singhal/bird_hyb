...
def sample_info(args):
    ...
    row = d.loc[d['sample'] == args.sample, ].to_dict('list')
...
def clean_up(args, out1, out2, out3, outSE, dir, o1, o2):
    out_stem = os.path.join(dir, args.sample)
    ...
    for file in out1 + out2 + out3 + [outSE, o1, o2]:
...
def main():
    ...
    # clean it all up!
    clean_up(args, outfiles1, outfiles2, outfiles3, outfileSE, dir, info['read1'], info['read2'])
